...
namespace TestLHS3UtilNS
{
    ...
    class TestLHS3 : public ::testing::Test
    {
        protected:
            ...
            std::unique_ptr< LHS3UtilNS::LHS3RequestContext > requestContext;
            ...
            {   
                ...
                requestContext = std::unique_ptr< LHS3UtilNS::LHS3RequestContext >(
                    new LHS3UtilNS::LHS3RequestContext(
    ...
    TEST_F( TestLHS3, TestLHS3ProcessContext )
    {
        bool thrown = false;

        LHS3UtilNS::LHS3ProcessContext::ProcessInitialize( host );

        try
        {
            LHS3UtilNS::LHS3ProcessContext::ProcessInitialize( "notAHost" );
        }
        catch( LHS3UtilNS::LHS3ProcessContextAlreadyInitialized e )
        {
            thrown = true;
        }
        catch( ... )
        ...
        ASSERT_TRUE( thrown ) <<
            "Double initialization succeeded when it "
             "should have failed";

        ASSERT_EQ( host, LHS3UtilNS::LHS3ProcessContext::DefaultHostName() ) <<
            "Default host is not as expected";

        thrown = false;
        LHS3UtilNS::LHS3ProcessContext::ProcessCleanup();
        try
        {
            LHS3UtilNS::LHS3ProcessContext::ProcessCleanup();
        }
    ...
    TEST_F( TestLHS3, TestRequestContext )
    {
        ...
        LHS3UtilNS::LHS3ProcessContext::ProcessInitialize( hostName );

        try
        {
            LHS3UtilNS::LHS3RequestContext requestContext( hostName,
                                                       accessKey,
                                                       secretKey );
            ...
            ASSERT_EQ( protocol, requestContext.Protocol() );
        ...
        try
        {
            LHS3UtilNS::LHS3RequestContext requestContext( emptyString,
                                                       accessKey,
                                                       secretKey );
    ...
    TEST_F( TestLHS3, TestCreateBucket )
    {
        ...
        LHS3UtilNS::LHS3Ret ret;
        LHS3UtilNS::LHS3Requester requester;
        ...
        ASSERT_EQ( LHS3UtilNS::LHS3Status::OK, ret.first ) <<
        ...
        ret = requester.CreateBucket( *requestContext, bucketName3 );
        ASSERT_EQ( LHS3UtilNS::LHS3Status::BucketExists, ret.first ) <<
            "Created duplicate bucket 3[" << ret.second << "]";

        ret = requester.CreateBucket( *requestContext, badBucketName1 );
        ASSERT_EQ( LHS3UtilNS::LHS3Status::BucketBadName, ret.first ) <<
    ...
    TEST_F( TestLHS3, TestBucketExists )
    {
        ...
        ASSERT_EQ( LHS3UtilNS::LHS3Status::BucketNotFound, ret.first ) <<
    ...
    TEST_F( TestLHS3, TestDeleteBucket )
    {
        ...
        ASSERT_EQ( LHS3UtilNS::LHS3Status::Error, ret.first ) <<
    ...
    TEST_F( TestLHS3, TestUploadObject )
    {
        ...
        LHS3UtilNS::LHS3IStreamUploader isu( ifs );
        LHS3UtilNS::LHS3IStreamUploader isu2( ifs2 );
        LHS3UtilNS::LHS3Ret ret;
        LHS3UtilNS::LHS3Requester requester;
        ...
        try
        {
            LHS3UtilNS::LHS3ProcessContext::ProcessInitialize( requestContext->Host() );
        }
        catch( ... )
        {
            ;
    ...
    TEST_F( TestLHS3, TestDownloadObject )
    {
        ...
        ret = requester.DownloadObject(
            *requestContext,
            ...
            objectName2,
            downloadedChars ); 
        ASSERT_EQ( LHS3UtilNS::LHS3Status::ObjectNotFound, ret.first ) <<
